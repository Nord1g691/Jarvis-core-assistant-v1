// JARVIS V8.9.1 — account and dashboard settings
...
function installSettingsUI() {
  ...
  const style=document.createElement("style"); style.textContent=`
    ...
    .jarvisTopIcon{position:absolute!important;top:max(12px,env(safe-area-inset-top))!important;right:12px!important;z-index:2147483000!important;width:38px!important;height:38px!important;padding:0!important;border:0!important;background:transparent!important;color:#7eefff!important;border-radius:0!important;font-size:18px!important;line-height:38px!important;text-align:center!important;box-shadow:none!important;transform:none!important}
    #jarvisSettingsButton{top:max(54px,calc(env(safe-area-inset-top) + 46px))!important;font-size:16px!important}
    .jarvisRefreshButton{position:absolute!important;top:max(96px,calc(env(safe-area-inset-top) + 88px))!important;right:12px!important;z-index:2147483000!important;width:38px!important;height:38px!important;padding:0!important;border:0!important;background:transparent!important;color:#7eefff!important;border-radius:0!important;font-size:18px!important;line-height:38px!important;text-align:center!important;box-shadow:none!important;transform:none!important}
  ...
  (app || document.body).append(accountButton,settingsButton,refreshButton);
  document.body.append(accountModal,settingsModal);
