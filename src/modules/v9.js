...
async function callService(s,on){const [domain]=s.entity_id.split(".");let service=on?"turn_on":"turn_off";if(domain==="lock")service=on?"lock":"unlock";if(domain==="cover")service=on?"open_cover":"close_cover";await haWsCall("call_service",{domain,service,service_data:{entity_id:s.entity_id}},token())}
function css(){
 ...
 body.jarvisV9ModalOpen #jarvisV9Nav,body.jarvisV9ModalOpen #jarvisV9Refresh,body.jarvisModalOpen #jarvisV9Nav,body.jarvisModalOpen #jarvisV9Refresh{display:none!important}
